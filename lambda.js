...
function getStormDetail(intent, session, device, callback) {
    ...
    if (stormDetailExists) {
 	...
 	var speechOutput = "";
        ...
        } else if (stormName.toLowerCase() === "barbara" || stormName.toLowerCase() === "xxx") {
...
function buildSlotDetail(slotName, slots) {
	...
	if (slots.Storm.value) {
		...
		// this is a common language problem with 'TS Gordon'
		if (slots.Storm.value.toLowerCase() === "garden") {
		    console.log("Mispelling of TS Gordon as Garden");
		    stormDetailExists = true;
		}
	    }
	    // this checks for current storm names - currently there are none
	    if (slots.Storm.value.toLowerCase() === "oscar" || slots.Storm.value.toLowerCase() === "xxx") {
